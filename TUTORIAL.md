...
- state update triggers re-render (re-render simply means function [Component] gets invoked/called)
...
- And during mounting and un-mounting progress (toggling a component)
